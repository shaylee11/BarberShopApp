 ...
 * Use the {@link admin_booking#newInstance} factory method to
 * create an instance of this fragment.
 */
public class admin_booking extends Fragment {

    View view;
    TextView barberName_text,orderDate_text,orderTime_text,user_name_text;
     ...
     * @return A new instance of fragment admin_booking.
     */
    // TODO: Rename and change types and number of parameters
    public static admin_booking newInstance(String param1, String param2) {
        admin_booking fragment = new admin_booking();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            appoint_userName = getArguments().getString("appoint_userName");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_admin_booking, container, false);
        ...
        DocumentReference documentReferenceBarber = fStore.collection("barbers")
                .document(barberID);
